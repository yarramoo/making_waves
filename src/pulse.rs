...
impl Pulse {
    pub(crate) fn new(frequency: f32, duration: f32 , volume: f32) -> Self {
        Self { frequency, duration, volume }
    }
    pub(crate) fn get_wave_data(&self, sample_rate: f32) -> Vec<f32> {
    ...
    pub(crate) fn with_attack_decay(&self, attack_dur: f32, decay_dur: f32, sample_rate: f32) -> Vec<f32> {
